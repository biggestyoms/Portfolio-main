...
const Home = () => {
  ...
  const finalText = "Oladimeji Oluwayomi Mayowa";
      ...
      <div className="introduction">
        <div className="introduction-texts">
          ...
          <div className="buttons">
            <button>
              <a href="https://1drv.ms/w/c/fee8a2d923928304/EY8JxU3GYURFlsM7kFSZk-4BoppjKz6F-susnuPmMRBSBQ">Download Resume</a>
              </button>
            <div className="socials">
              <a href="https://www.instagram.com/biggestyomsss?igsh=MXE0czBxbnRnejhjNQ%3D%3D&utm_source=qr">
                <div className="insta">
                  <FaInstagramSquare />
                </div>
              </a>
              <a href="https://x.com/mayowaofl?s=21">
                <div className="insta">
                  <BsTwitterX />
                </div>
              </a>
